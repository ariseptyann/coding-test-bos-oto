<x-app-layout>
    ...
    @section('script')
        ...
        <script type="text/javascript">
            ...
            // Search
            $(document).on('keyup', 'input[name=city_name]', function(e){
                e.preventDefault();
                var searchParams = new URLSearchParams(window.location.search);
                searchParams.set(`page`, '1');
                var newUrl = '?'+searchParams.toString();
                ...
                let name = $('input[name=city_name]').val();
                let queryString = `city_name`;
            ...
            $(document).on('change', 'select[name=province_id]', function(e){
                ...
                let name = $('select[name=province_id]').val();
                let queryString = `province_id`;
                getQueryString(queryString, name);
            });
